...
1. Visit [ai.modelset.top/login](https://ai.modelset.top/login) to register (free, no credit card)
...
Log in to your dashboard at [ai.modelset.top/login](https://ai.modelset.top/login) to view:
- Current balance
- Usage history
- API Key management
...
Contact our support team via the [Help Center](https://ai.modelset.top/about) for refund requests.
...
- [Help Center](https://ai.modelset.top/about) — Tutorials, guides, and support
- [Official Community Group](https://ai.modelset.top/about) — Get help, share feedback
